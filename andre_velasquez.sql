...
--
-- Host: localhost    Database: andre_velasquez
-- ------------------------------------------------------
...
CREATE TABLE `flavortreat` (
  `FlavorTreatId` int NOT NULL,
  `FlavorId` int NOT NULL,
  `TreatId` int NOT NULL,
  PRIMARY KEY (`FlavorTreatId`),
  KEY `FlavorId_idx` (`FlavorId`),
  KEY `TreatId_idx` (`TreatId`),
  CONSTRAINT `FlavorId` FOREIGN KEY (`FlavorId`) REFERENCES `flavor` (`FlavorId`),
  CONSTRAINT `TreatId` FOREIGN KEY (`TreatId`) REFERENCES `treat` (`TreatId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-05 21:38:04
